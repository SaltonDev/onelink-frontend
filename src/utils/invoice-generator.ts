...
export const generateInvoicePDF = (invoice: any) => {
  ...
  doc.text("Thank you for your business. Please include Invoice # in remarks.", 105, pageHeight - 15, { align: 'center' })
  doc.text("Generated by OneLink Property Management System", 105, pageHeight - 10, { align: 'center' })
